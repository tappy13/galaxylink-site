// =============================================================================
// GalaxyLink Computers - E-Commerce Style Interactions
// =============================================================================
...
document.querySelectorAll('.btn-product').forEach(button => {
  button.addEventListener('click', function() {
    ...
    // Pre-fill product info in form (if you want)
    setTimeout(() => {
...
document.querySelectorAll('.category-card').forEach(card => {
  card.addEventListener('click', function() {
    ...
    // Optional: You could filter products here if you have that functionality
...
document.querySelectorAll('.product-card, .service-card, .category-card, .feature-box').forEach(el => {
  el.style.opacity = '0';
...
console.log('%cGalaxyLink Computers', 'color: #1E90FF; font-size: 24px; font-weight: bold;');
console.log('%cWebsite loaded successfully!', 'color: #10b981; font-size: 14px;');
console.log('Need IT solutions? Contact us today!');
